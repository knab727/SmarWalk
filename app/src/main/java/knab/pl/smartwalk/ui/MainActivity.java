...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new SolesFragment(), getString(R.string.center_mass));
        adapter.addFragment(new SoleSensorGraphFragment(), getString(R.string.pressure_sensors));
        adapter.addFragment(new GoniometerFragment(), getString(R.string.goniometers));
